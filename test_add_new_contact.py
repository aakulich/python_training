...
class TestAddNewContact(unittest.TestCase):
    ...
    def create_new_contact(self, wd, firstname="first", middlename="middle", lastname="last", nickname="nick",
        ...
        self.set_birthdate(bday, bmonth, byear, wd)
        self.set_annivdate(aday, amonth, ayear, wd)
    ...
    def set_annivdate(self, aday, amonth, ayear, wd):
    ...
    def set_birthdate(self, bday, bmonth, byear, wd):
